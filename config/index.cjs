...
const USER_CONFIG = {
  ...
  TIAN_API: {
    ...
    key: '08260dfc6f106568ec626c89691e284e',
  ...
  USERS: [
    {
      ...
      id: ['SCT201699TCplwSWsQNr4H7NeztvZ2ISyq,SCT201074T6VfW1unHzHT57YZGqTs6oWcq'],
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '姐姐', year: '2002', date: '02-06',
        },
        {
          type: '节日', name: '清明', year: '2002', date: '04-05',
        },
      ],
  ...
  CALLBACK_USERS: [
    {
      ...
      // 使用其他通道时，请严格按照各个通道的教程进行填写
      id: 'SCT201074T6VfW1unHzHT57YZGqTs6oWcq',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
